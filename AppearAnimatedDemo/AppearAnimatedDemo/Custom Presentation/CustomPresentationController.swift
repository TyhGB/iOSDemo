...
extension CustomPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        let presentationRoundedCornerView = UIView(frame: presentationWrapperView.bounds.inset(by: UIEdgeInsets(top: 0, left: 0, bottom: -CORNER_RADIUS, right: 0))) // 添加圆角效果
...
extension CustomPresentationController {
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        let presentedViewControllerFrame = CGRect.init(x: containerViewBounds!.origin.x, y: containerViewBounds!.maxY - presentedViewContentSize.height, width: (containerViewBounds?.size.width)!, height: presentedViewContentSize.height)
