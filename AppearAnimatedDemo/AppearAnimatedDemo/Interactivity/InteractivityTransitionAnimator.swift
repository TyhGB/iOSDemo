...
//        }
        ...
        case UIRectEdge.top: offset = CGVector.init(dx: 0, dy: 1)
        case UIRectEdge.bottom: offset = CGVector.init(dx: 0, dy: -1)
        case UIRectEdge.left: offset = CGVector.init(dx: 1, dy: 0)
        case UIRectEdge.right: offset = CGVector.init(dx: -1, dy: 0)
